...
class BertForMaskedLM(PreTrainedBertModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, tgt_pos=None, mask_pos=None, tgt_layer=None, tmp_score=None, tgt_label=None, imp_pos=None, imp_op=None):
        if tmp_score is not None:
        ...
        if mask_pos is None:
            mask_pos = tgt_pos
        last_hidden = last_hidden[:, mask_pos, :]  # (batch, hidden_size)
        ffn_weights = ffn_weights[:, mask_pos, :]  # (batch, ffn_size)
